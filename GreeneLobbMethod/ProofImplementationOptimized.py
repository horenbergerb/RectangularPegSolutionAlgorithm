...
#########################
#diagonal angle of desired rectangle
phi = pi/4.0
...
rtol = 1e-5
atol = 8e-2
#The interval between samples if you're using the function-generated curve instead of a custom-drawn curve
...
#divide and conquer 4-dimensional closest points problem
